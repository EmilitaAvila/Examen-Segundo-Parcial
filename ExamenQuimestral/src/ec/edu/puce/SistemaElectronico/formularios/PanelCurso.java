...
public class PanelCurso extends JInternalFrame implements ActionListener {
	...
	public PanelCurso( List<Curso> cursos) {
		...
		btnAnadirCandidato.setBackground(new Color(64, 0, 64));
		...
		btnLimpiarCandidato.setBackground(new Color(64, 0, 64));
		...
		btnSalirCandidato.setBackground(new Color(64, 0, 64));
