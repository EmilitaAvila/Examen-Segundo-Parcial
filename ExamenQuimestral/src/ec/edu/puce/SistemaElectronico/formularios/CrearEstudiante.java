...
public class CrearEstudiante extends JInternalFrame implements ActionListener {
	...
	public CrearEstudiante(List<Curso> cursos, List<Estudiante> estudiantes) {
		...
		btnNuevo.setBackground(new Color(128, 128, 64));
		...
		btnGuardar.setBackground(new Color(128, 128, 64));
		...
		btnCancelar.setBackground(new Color(128, 128, 64));
