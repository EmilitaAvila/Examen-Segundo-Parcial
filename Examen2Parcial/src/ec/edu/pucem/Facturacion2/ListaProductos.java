...
public class ListaProductos extends JDialog {
	...
	public ListaProductos(Dialog owner, boolean modal, DefaultTableModel model, ArrayList<Productos> productos, JLabel lblSubtotal, JLabel lblIVA, JLabel lblTotal) {
		super(owner, modal);
		...
		scrollPane.setViewportView(table);
		{
			...
			lblCantidad.setIcon(new ImageIcon("C:\\Users\\navar\\Downloads\\dinero.png"));
			lblCantidad.setFont(new Font("MS PGothic", Font.BOLD, 12));
...

		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setIcon(new ImageIcon("C:\\Users\\navar\\Downloads\\cheque.png")); // Ruta del ícono
	...
	private void agregarProductos() {
		ArrayList<Productos> productos = new ArrayList<Productos>(FrmProductos.getProductos());
	...
	private boolean validarCantidad() {
		try {
			...
			if (a > FrmProductos.getProductos().get(indiceProducto).getCantidad()) {
